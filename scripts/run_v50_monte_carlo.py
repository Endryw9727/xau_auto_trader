"""
Run Monte Carlo reshuffling for final V50 candidates.
...
from src.strategy_lab.v50_monte_carlo import (
    DEFAULT_V50_MONTE_CARLO_PATH,
    run_v50_monte_carlo,
)
...
def main() -> None:
    """Run Monte Carlo simulations from local CSV data."""
    print("=" * 72)
    print("XAU Auto Trader - V50 Monte Carlo")
    print("=" * 72)
    ...
    print(f"Iterations: {MONTE_CARLO_ITERATIONS}")
    ...
    report = run_v50_monte_carlo(
        df=df,
        strategy_config=strategy_config,
        backtest_config=backtest_config,
        iterations=MONTE_CARLO_ITERATIONS,
        output_path=DEFAULT_V50_MONTE_CARLO_PATH,
        show_progress=True,
    )
    ...
    print("")
    print(f"Monte Carlo report exported: {DEFAULT_V50_MONTE_CARLO_PATH}")
